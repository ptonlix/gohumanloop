...
class TestDefaultHumanLoopManager(IsolatedAsyncioTestCase):
    ...
    async def test_check_request_status(self):
        ...
        self.provider.check_request_status_mock.assert_called_once_with(
        ...
        provider2.check_request_status_mock.assert_called_once_with(
            "test-conversation", "test-request"
        )
    ...
    async def test_check_conversation_status(self):
        ...
        self.assertEqual(result, self.result)
        self.provider.check_conversation_status_mock.assert_called_once_with(
            "test-conversation"
        )
        ...
        await self.manager.check_conversation_status(
            conversation_id="test-conversation", provider_id="provider2"
        )

        provider2.check_conversation_status_mock.assert_called_once_with(
            "test-conversation"
        )
        ...
        with self.assertRaises(ValueError):
            await self.manager.check_conversation_status(
                conversation_id="test-conversation", provider_id="non-existent-provider"
            )
    ...
    async def test_cancel_request(self):
        ...
        self.provider.cancel_request_mock.assert_called_once_with(
            "test-conversation", "test-request"
        )
        ...
        provider2.cancel_request_mock.assert_called_once_with(
            "test-conversation", "test-request"
        )
    ...
    async def test_cancel_conversation(self):
        ...
        self.assertTrue(result)
        self.provider.cancel_conversation_mock.assert_called_once_with(
            "test-conversation"
        )
